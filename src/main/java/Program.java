...
public class Program {
        ...
        if (command.equals("print"))
        {
            ...
            for (String line: tableLines)
            {
                ...
                for (String sentence: line.split(",")) {
                    tableLine = tableLine.concat(padLeft(sentence, 16) + " | ");
                }
            ...
            System.out.println("| " + padLeft("Number of sales", 30) +  " | " + padLeft(""+numberOfSales, 10) + " |");
            System.out.println("| " + padLeft("Number of clients", 30) +  " | " + padLeft(""+clients.size(), 10) + " |");

            System.out.println("| " + padLeft("Total items sold", 30) +  " | " + padLeft(""+totalItemsSold, 10) + " |");
            System.out.println("| " + padLeft("Total sales amount", 30) +  " | " + padLeft("$" + String.format("%.2f", totalSalesAmount), 10) + " |");

            System.out.println("| " + padLeft("Average amount/sale", 30) +  " | " + padLeft("$"+averageAmountSale, 10) + " |");
            System.out.println("| " + padLeft("Average item price", 30) +  " | " + padLeft("$"+averageItemPrice, 10) + " |");
    ...
    private static void trimCells(String[] cells) {
